          ...
          <div className="flex bg-white p-4 pt-16">
            ...
            <div className="w-1/2 p-8 pl-0">
              ...
              <div className="flex text-gray-500 items-center mt-4">
                <button onClick={addToCartHandler} disabled={product.numStock < 1} className="w-1/3 bg-gray-900 text-white border rounded-2xl p-2 hover:bg-gray-700 disabled:bg-gray-500">Add To Bag</button>
                <p className="mx-6"> or </p>
                <button className="w-1/3 bg-white text-black border rounded-2xl p-2 hover:bg-gray-200">Favorite</button>
              </div>
